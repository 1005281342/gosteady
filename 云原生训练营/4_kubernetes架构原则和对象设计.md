...
- Self-hosting 是目标。kubelet 有 systemd 管控，类似 apiserver、controller、scheduler 等组件都是 Kubernetes 自己管控的，通过 kubelet 创建 pod 启动
- 减少依赖，特别是稳态运行的依赖
- 通过分层的原则管理依赖
- 循环依赖问题的原则：
...
![](4_kubernetes架构原则和对象设计.assets/image-20221016155711360.png)
