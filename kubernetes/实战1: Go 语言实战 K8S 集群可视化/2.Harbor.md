...
1. docker、docker-compose 等环境安装 https://goharbor.io/docs/2.8.0/install-config/installation-prereqs/

2. 离线安装包下载 https://github.com/goharbor/harbor/releases，然后解压 `tar xzvf harbor-offline-installer-version.tgz`

3. 相关配置 https://goharbor.io/docs/2.8.0/install-config/configure-https/，整理脚本如下：
...
4. 切换到离线安装包解压目录中配置 harbor `cp harbor.yml.tmpl harbor.yml`，然后修改
   ...
   # external_url: https://harbor.kubeimooc.com:8433
